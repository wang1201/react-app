...
class newKitchenContainer extends Component{
    constructor(props){
        super(props)
        console.log(this);
    ...
    // RenderList(){
    //     let { list,newKitchen } = this.state
    //     return newKitchen.map(item=>(
    ...
    //         )
    //     }
    //     if(item.classify_name === "美食生活" || item.classify_name === "秘味光影"){
    //         return(
...
export default newKitchenContainer
